...
(function(root, factory) {
  ...
  describe('InvoiceServiceApi', function() {
    describe('getBillingPortalURL', function() {
      it('should call getBillingPortalURL successfully', function(done) {
        //uncomment below and update the code to test getBillingPortalURL
        //instance.getBillingPortalURL(function(error) {
