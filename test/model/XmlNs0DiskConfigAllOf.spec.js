...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.XmlNs0DiskConfigAllOf();
  });
  ...
  describe('XmlNs0DiskConfigAllOf', function() {
    it('should create an instance of XmlNs0DiskConfigAllOf', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.XmlNs0DiskConfigAllOf();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.XmlNs0DiskConfigAllOf);
    });
