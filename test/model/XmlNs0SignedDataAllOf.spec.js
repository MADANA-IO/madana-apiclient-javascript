...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.XmlNs0SignedDataAllOf();
  });
  ...
  describe('XmlNs0SignedDataAllOf', function() {
    it('should create an instance of XmlNs0SignedDataAllOf', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.XmlNs0SignedDataAllOf();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.XmlNs0SignedDataAllOf);
    });
