...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.XmlNs0DiskConfigAllOf();
  });
  ...
  describe('XmlNs0DiskConfigAllOf', function() {
    it('should create an instance of XmlNs0DiskConfigAllOf', function() {
      // uncomment below and update the code to test XmlNs0DiskConfigAllOf
      //var instane = new MadanaApiclient.XmlNs0DiskConfigAllOf();
      //expect(instance).to.be.a(MadanaApiclient.XmlNs0DiskConfigAllOf);
    });

    it('should have the property disk (base name: "disk")', function() {
      // uncomment below and update the code to test the property disk
      //var instance = new MadanaApiclient.XmlNs0DiskConfigAllOf();
