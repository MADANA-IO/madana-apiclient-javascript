...
/**
 * The XmlNs0EnvironmentAllOf model module.
 * @module model/XmlNs0EnvironmentAllOf
 * @version 0.4.14-master.22
 */
class XmlNs0EnvironmentAllOf {
    /**
     * Constructs a new <code>XmlNs0EnvironmentAllOf</code>.
     * @alias module:model/XmlNs0EnvironmentAllOf
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>XmlNs0EnvironmentAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XmlNs0EnvironmentAllOf} obj Optional instance to populate.
     * @return {module:model/XmlNs0EnvironmentAllOf} The populated <code>XmlNs0EnvironmentAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XmlNs0EnvironmentAllOf();
...
export default XmlNs0EnvironmentAllOf;
