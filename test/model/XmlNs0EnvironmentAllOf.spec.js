...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.XmlNs0EnvironmentAllOf();
  });
  ...
  describe('XmlNs0EnvironmentAllOf', function() {
    it('should create an instance of XmlNs0EnvironmentAllOf', function() {
      // uncomment below and update the code to test XmlNs0EnvironmentAllOf
      //var instane = new MadanaApiclient.XmlNs0EnvironmentAllOf();
      //expect(instance).to.be.a(MadanaApiclient.XmlNs0EnvironmentAllOf);
    });

    it('should have the property content (base name: "content")', function() {
      // uncomment below and update the code to test the property content
      //var instance = new MadanaApiclient.XmlNs0EnvironmentAllOf();
