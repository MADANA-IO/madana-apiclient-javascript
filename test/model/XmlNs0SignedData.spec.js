...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.XmlNs0SignedData();
  });
  ...
  describe('XmlNs0SignedData', function() {
    it('should create an instance of XmlNs0SignedData', function() {
      // uncomment below and update the code to test XmlNs0SignedData
      //var instane = new MadanaApiclient.XmlNs0SignedData();
      //expect(instance).to.be.a(MadanaApiclient.XmlNs0SignedData);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new MadanaApiclient.XmlNs0SignedData();
