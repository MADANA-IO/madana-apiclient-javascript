...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.DataCollectionServiceApi();
  });
  ...
  describe('DataCollectionServiceApi', function() {
    describe('getMethodsForType', function() {
      it('should call getMethodsForType successfully', function(done) {
        //uncomment below and update the code to test getMethodsForType
        //instance.getMethodsForType(function(error) {
