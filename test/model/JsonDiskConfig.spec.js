...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.JsonDiskConfig();
  });
  ...
  describe('JsonDiskConfig', function() {
    it('should create an instance of JsonDiskConfig', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.JsonDiskConfig();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.JsonDiskConfig);
    });
