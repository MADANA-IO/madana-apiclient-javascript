...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.XmlNs0DiskConfig();
  });
  ...
  describe('XmlNs0DiskConfig', function() {
    it('should create an instance of XmlNs0DiskConfig', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.XmlNs0DiskConfig();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.XmlNs0DiskConfig);
    });
