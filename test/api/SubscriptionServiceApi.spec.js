...
(function(root, factory) {
  ...
  describe('SubscriptionServiceApi', function() {
    ...
    describe('getActivePaaSSubscriptions', function() {
      it('should call getActivePaaSSubscriptions successfully', function(done) {
        //uncomment below and update the code to test getActivePaaSSubscriptions
        //instance.getActivePaaSSubscriptions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getActiveSaaSSubscriptions', function() {
      it('should call getActiveSaaSSubscriptions successfully', function(done) {
        //uncomment below and update the code to test getActiveSaaSSubscriptions
        //instance.getActiveSaaSSubscriptions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
