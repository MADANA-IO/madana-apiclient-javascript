...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.JsonKubernetesEnclave();
  });
  ...
  describe('JsonKubernetesEnclave', function() {
    it('should create an instance of JsonKubernetesEnclave', function() {
      // uncomment below and update the code to test JsonKubernetesEnclave
      //var instane = new MadanaApiclient.JsonKubernetesEnclave();
      //expect(instance).to.be.a(MadanaApiclient.JsonKubernetesEnclave);
    });
    ...
    it('should have the property enclaveIdent (base name: "enclaveIdent")', function() {
      ...
      //var instance = new MadanaApiclient.JsonKubernetesEnclave();
