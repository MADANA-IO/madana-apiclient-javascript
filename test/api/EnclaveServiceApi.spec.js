...
(function(root, factory) {
  ...
  describe('EnclaveServiceApi', function() {
    ...
    describe('redistTest', function() {
      it('should call redistTest successfully', function(done) {
        //uncomment below and update the code to test redistTest
        //instance.redistTest(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
