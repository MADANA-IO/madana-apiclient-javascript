...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.XmlNs0IPFSSystemInfoAllOf();
  });
  ...
  describe('XmlNs0IPFSSystemInfoAllOf', function() {
    it('should create an instance of XmlNs0IPFSSystemInfoAllOf', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.XmlNs0IPFSSystemInfoAllOf();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.XmlNs0IPFSSystemInfoAllOf);
    });
