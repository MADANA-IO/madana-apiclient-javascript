...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.JsonV1ListMeta();
  });
  ...
  describe('JsonV1ListMeta', function() {
    it('should create an instance of JsonV1ListMeta', function() {
      // uncomment below and update the code to test JsonV1ListMeta
      //var instane = new MadanaApiclient.JsonV1ListMeta();
      //expect(instance).to.be.a(MadanaApiclient.JsonV1ListMeta);
    });
    ...
    it('should have the property selfLink (base name: "selfLink")', function() {
      ...
      //var instance = new MadanaApiclient.JsonV1ListMeta();
