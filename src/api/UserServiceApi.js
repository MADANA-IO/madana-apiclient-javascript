...
export default class UserServiceApi {
    ...
    */
     ...
     * @callback module:api/UserServiceApi~cancelSubscriptionCallback
     ...
     * @param {module:api/UserServiceApi~cancelSubscriptionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    cancelSubscription(planname, username, callback) {
      let postBody = null;
      // verify the required parameter 'planname' is set
      if (planname === undefined || planname === null) {
        throw new Error("Missing the required parameter 'planname' when calling cancelSubscription");
      }
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling cancelSubscription");
      }
      ...
      return this.apiClient.callApi(
        '/users/{username}/subscriptions/{planname}/cancel', 'POST',
