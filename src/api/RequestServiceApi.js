...
export default class RequestServiceApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAllRequests2 operation.
     * @callback module:api/RequestServiceApi~getAllRequests2Callback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/RequestServiceApi~getAllRequests2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    getAllRequests2(opts, callback) {
      opts = opts || {};
      let postBody = null;
