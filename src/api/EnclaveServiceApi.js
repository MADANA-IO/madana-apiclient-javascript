...
export default class EnclaveServiceApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the redistTest operation.
     * @callback module:api/EnclaveServiceApi~redistTestCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * @param {module:api/EnclaveServiceApi~redistTestCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    redistTest(callback) {
      let postBody = null;
