...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.XmlNs0IPFSSystemInfo();
  });
  ...
  describe('XmlNs0IPFSSystemInfo', function() {
    it('should create an instance of XmlNs0IPFSSystemInfo', function() {
      // uncomment below and update the code to test XmlNs0IPFSSystemInfo
      //var instane = new MadanaApiclient.XmlNs0IPFSSystemInfo();
      //expect(instance).to.be.a(MadanaApiclient.XmlNs0IPFSSystemInfo);
    });
    ...
    it('should have the property agentVersion (base name: "agentVersion")', function() {
      ...
      //var instance = new MadanaApiclient.XmlNs0IPFSSystemInfo();
