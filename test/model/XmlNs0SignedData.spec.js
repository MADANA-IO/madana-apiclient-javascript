...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.XmlNs0SignedData();
  });
  ...
  describe('XmlNs0SignedData', function() {
    it('should create an instance of XmlNs0SignedData', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.XmlNs0SignedData();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.XmlNs0SignedData);
    });
