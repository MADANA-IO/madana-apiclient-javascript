...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.JsonMDNAUserObject();
  });
  ...
  describe('JsonMDNAUserObject', function() {
    it('should create an instance of JsonMDNAUserObject', function() {
      // uncomment below and update the code to test JsonMDNAUserObject
      //var instane = new MadanaApiclient.JsonMDNAUserObject();
      //expect(instance).to.be.a(MadanaApiclient.JsonMDNAUserObject);
    });

    it('should have the property image (base name: "image")', function() {
      // uncomment below and update the code to test the property image
      //var instance = new MadanaApiclient.JsonMDNAUserObject();
