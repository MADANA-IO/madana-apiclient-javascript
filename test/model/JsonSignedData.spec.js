...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.JsonSignedData();
  });
  ...
  describe('JsonSignedData', function() {
    it('should create an instance of JsonSignedData', function() {
      // uncomment below and update the code to test JsonSignedData
      //var instane = new MadanaApiclient.JsonSignedData();
      //expect(instance).to.be.a(MadanaApiclient.JsonSignedData);
    });
    ...
    it('should have the property fingerpint (base name: "fingerpint")', function() {
      ...
      //var instance = new MadanaApiclient.JsonSignedData();
