...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.XmlNs0Environment();
  });
  ...
  describe('XmlNs0Environment', function() {
    it('should create an instance of XmlNs0Environment', function() {
      // uncomment below and update the code to test XmlNs0Environment
      //var instane = new MadanaApiclient.XmlNs0Environment();
      //expect(instance).to.be.a(MadanaApiclient.XmlNs0Environment);
    });

    it('should have the property content (base name: "content")', function() {
      // uncomment below and update the code to test the property content
      //var instance = new MadanaApiclient.XmlNs0Environment();
