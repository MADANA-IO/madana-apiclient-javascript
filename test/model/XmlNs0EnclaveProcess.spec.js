...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.XmlNs0EnclaveProcess();
  });
  ...
  describe('XmlNs0EnclaveProcess', function() {
    it('should create an instance of XmlNs0EnclaveProcess', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.XmlNs0EnclaveProcess();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.XmlNs0EnclaveProcess);
    });
