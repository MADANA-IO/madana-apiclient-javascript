...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.XmlNs0KubernetesEnclave();
  });
  ...
  describe('XmlNs0KubernetesEnclave', function() {
    it('should create an instance of XmlNs0KubernetesEnclave', function() {
      // uncomment below and update the code to test XmlNs0KubernetesEnclave
      //var instane = new MadanaApiclient.XmlNs0KubernetesEnclave();
      //expect(instance).to.be.a(MadanaApiclient.XmlNs0KubernetesEnclave);
    });
    ...
    it('should have the property attestationServer (base name: "attestationServer")', function() {
      ...
      //var instance = new MadanaApiclient.XmlNs0KubernetesEnclave();
