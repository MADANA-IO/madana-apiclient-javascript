...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.XmlNs0EnclaveProcessAllOf();
  });
  ...
  describe('XmlNs0EnclaveProcessAllOf', function() {
    it('should create an instance of XmlNs0EnclaveProcessAllOf', function() {
      // uncomment below and update the code to test XmlNs0EnclaveProcessAllOf
      //var instane = new MadanaApiclient.XmlNs0EnclaveProcessAllOf();
      //expect(instance).to.be.a(MadanaApiclient.XmlNs0EnclaveProcessAllOf);
    });
    ...
    it('should have the property attestationServer (base name: "attestationServer")', function() {
      ...
      //var instance = new MadanaApiclient.XmlNs0EnclaveProcessAllOf();
