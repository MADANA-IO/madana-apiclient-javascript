...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.XmlNs0DiskConfig();
  });
  ...
  describe('XmlNs0DiskConfig', function() {
    it('should create an instance of XmlNs0DiskConfig', function() {
      // uncomment below and update the code to test XmlNs0DiskConfig
      //var instane = new MadanaApiclient.XmlNs0DiskConfig();
      //expect(instance).to.be.a(MadanaApiclient.XmlNs0DiskConfig);
    });

    it('should have the property disk (base name: "disk")', function() {
      // uncomment below and update the code to test the property disk
      //var instance = new MadanaApiclient.XmlNs0DiskConfig();
