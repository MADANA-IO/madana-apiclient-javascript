...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.XmlNs0NodeInfoAllOf();
  });
  ...
  describe('XmlNs0NodeInfoAllOf', function() {
    it('should create an instance of XmlNs0NodeInfoAllOf', function() {
      // uncomment below and update the code to test XmlNs0NodeInfoAllOf
      //var instane = new MadanaApiclient.XmlNs0NodeInfoAllOf();
      //expect(instance).to.be.a(MadanaApiclient.XmlNs0NodeInfoAllOf);
    });
    ...
    it('should have the property connectionURL (base name: "connectionURL")', function() {
      ...
      //var instance = new MadanaApiclient.XmlNs0NodeInfoAllOf();
