...
export default class SubscriptionServiceApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getActivePaaSSubscriptions operation.
     * @callback module:api/SubscriptionServiceApi~getActivePaaSSubscriptionsCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * @param {module:api/SubscriptionServiceApi~getActivePaaSSubscriptionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    getActivePaaSSubscriptions(callback) {
      let postBody = null;
     ...
     * @callback module:api/SubscriptionServiceApi~getActiveSaaSSubscriptionsCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * @param {module:api/SubscriptionServiceApi~getActiveSaaSSubscriptionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    getActiveSaaSSubscriptions(callback) {
      let postBody = null;
