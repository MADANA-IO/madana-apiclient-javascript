...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.JsonEnclaveProcess();
  });
  ...
  describe('JsonEnclaveProcess', function() {
    it('should create an instance of JsonEnclaveProcess', function() {
      // uncomment below and update the code to test JsonEnclaveProcess
      //var instane = new MadanaApiclient.JsonEnclaveProcess();
      //expect(instance).to.be.a(MadanaApiclient.JsonEnclaveProcess);
    });

    it('should have the property ports (base name: "ports")', function() {
      // uncomment below and update the code to test the property ports
      //var instance = new MadanaApiclient.JsonEnclaveProcess();
