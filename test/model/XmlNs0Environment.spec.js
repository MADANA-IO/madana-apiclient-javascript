...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.XmlNs0Environment();
  });
  ...
  describe('XmlNs0Environment', function() {
    it('should create an instance of XmlNs0Environment', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.XmlNs0Environment();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.XmlNs0Environment);
    });
