...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.XmlNs0NodeInfoAllOf();
  });
  ...
  describe('XmlNs0NodeInfoAllOf', function() {
    it('should create an instance of XmlNs0NodeInfoAllOf', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.XmlNs0NodeInfoAllOf();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.XmlNs0NodeInfoAllOf);
    });
