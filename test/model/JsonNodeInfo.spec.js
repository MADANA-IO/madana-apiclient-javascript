...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.JsonNodeInfo();
  });
  ...
  describe('JsonNodeInfo', function() {
    it('should create an instance of JsonNodeInfo', function() {
      ...
      //var instane = new MadanaApiclient.JsonNodeInfo();
      //expect(instance).to.be.a(MadanaApiclient.JsonNodeInfo);
    });
    ...
    it('should have the property connectionURL (base name: "connectionURL")', function() {
      ...
      //var instance = new MadanaApiclient.JsonNodeInfo();
