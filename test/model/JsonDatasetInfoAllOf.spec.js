...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.JsonDatasetInfoAllOf();
  });
  ...
  describe('JsonDatasetInfoAllOf', function() {
    it('should create an instance of JsonDatasetInfoAllOf', function() {
      // uncomment below and update the code to test JsonDatasetInfoAllOf
      //var instane = new MadanaSampleclientJavascript.JsonDatasetInfoAllOf();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.JsonDatasetInfoAllOf);
    });
