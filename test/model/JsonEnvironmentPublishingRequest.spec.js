...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.JsonEnvironmentPublishingRequest();
  });
  ...
  describe('JsonEnvironmentPublishingRequest', function() {
    it('should create an instance of JsonEnvironmentPublishingRequest', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.JsonEnvironmentPublishingRequest();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.JsonEnvironmentPublishingRequest);
    });
