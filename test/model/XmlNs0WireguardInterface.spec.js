...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.XmlNs0WireguardInterface();
  });
  ...
  describe('XmlNs0WireguardInterface', function() {
    it('should create an instance of XmlNs0WireguardInterface', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.XmlNs0WireguardInterface();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.XmlNs0WireguardInterface);
    });
