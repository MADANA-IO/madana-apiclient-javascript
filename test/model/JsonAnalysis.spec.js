...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.JsonAnalysis();
  });
  ...
  describe('JsonAnalysis', function() {
    it('should create an instance of JsonAnalysis', function() {
      // uncomment below and update the code to test JsonAnalysis
      //var instane = new MadanaSampleclientJavascript.JsonAnalysis();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.JsonAnalysis);
    });
