...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.JsonEnvironment();
  });
  ...
  describe('JsonEnvironment', function() {
    it('should create an instance of JsonEnvironment', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.JsonEnvironment();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.JsonEnvironment);
    });
