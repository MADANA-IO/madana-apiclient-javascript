...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.JsonMDNUserAllOf();
  });
  ...
  describe('JsonMDNUserAllOf', function() {
    it('should create an instance of JsonMDNUserAllOf', function() {
      // uncomment below and update the code to test JsonMDNUserAllOf
      //var instane = new MadanaApiclient.JsonMDNUserAllOf();
      //expect(instance).to.be.a(MadanaApiclient.JsonMDNUserAllOf);
    });

    it('should have the property firstName (base name: "firstName")', function() {
      // uncomment below and update the code to test the property firstName
      //var instance = new MadanaApiclient.JsonMDNUserAllOf();
