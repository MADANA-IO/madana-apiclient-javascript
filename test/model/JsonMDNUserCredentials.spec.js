...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.JsonMDNUserCredentials();
  });
  ...
  describe('JsonMDNUserCredentials', function() {
    it('should create an instance of JsonMDNUserCredentials', function() {
      ...
      //var instane = new MadanaApiclient.JsonMDNUserCredentials();
      //expect(instance).to.be.a(MadanaApiclient.JsonMDNUserCredentials);
    });

    it('should have the property username (base name: "username")', function() {
      // uncomment below and update the code to test the property username
      //var instance = new MadanaApiclient.JsonMDNUserCredentials();
