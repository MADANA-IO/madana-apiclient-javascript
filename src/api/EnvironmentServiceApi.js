...
export default class EnvironmentServiceApi {
    ...
    */
     ...
     * @callback module:api/EnvironmentServiceApi~getAllRequestsCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/EnvironmentServiceApi~getAllRequestsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
