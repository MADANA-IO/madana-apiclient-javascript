...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaApiclient.XmlNs0IPFSSystemInfoAllOf();
  });
  ...
  describe('XmlNs0IPFSSystemInfoAllOf', function() {
    it('should create an instance of XmlNs0IPFSSystemInfoAllOf', function() {
      // uncomment below and update the code to test XmlNs0IPFSSystemInfoAllOf
      //var instane = new MadanaApiclient.XmlNs0IPFSSystemInfoAllOf();
      //expect(instance).to.be.a(MadanaApiclient.XmlNs0IPFSSystemInfoAllOf);
    });
    ...
    it('should have the property agentVersion (base name: "agentVersion")', function() {
      ...
      //var instance = new MadanaApiclient.XmlNs0IPFSSystemInfoAllOf();
