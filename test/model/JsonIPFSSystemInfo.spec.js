...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.JsonIPFSSystemInfo();
  });
  ...
  describe('JsonIPFSSystemInfo', function() {
    it('should create an instance of JsonIPFSSystemInfo', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.JsonIPFSSystemInfo();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.JsonIPFSSystemInfo);
    });
