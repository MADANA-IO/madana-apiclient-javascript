...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.JsonMDNMailAddress();
  });
  ...
  describe('JsonMDNMailAddress', function() {
    it('should create an instance of JsonMDNMailAddress', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.JsonMDNMailAddress();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.JsonMDNMailAddress);
    });
