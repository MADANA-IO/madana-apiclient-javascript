...
export default class SystemServiceApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getApplication2 operation.
     * @callback module:api/SystemServiceApi~getApplication2Callback
     * @param {String} error Error message, if any.
     ...
     * Return the current application usage
     * @param {module:api/SystemServiceApi~getApplication2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object.<String, {String: Object}>}
     */
    getApplication2(callback) {
      let postBody = null;
