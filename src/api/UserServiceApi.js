...
export default class UserServiceApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createObject2 operation.
     * @callback module:api/UserServiceApi~createObject2Callback
     ...
     * @param {module:api/UserServiceApi~createObject2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    createObject2(opts, callback) {
      opts = opts || {};
    ...
    /**
     * Callback function to receive the result of the updateObject2 operation.
     * @callback module:api/UserServiceApi~updateObject2Callback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/UserServiceApi~updateObject2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    updateObject2(username, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling updateObject2");
      }
