...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.RequestServiceApi();
  });
  ...
  describe('RequestServiceApi', function() {
    ...
    describe('getAllRequests2', function() {
      it('should call getAllRequests2 successfully', function(done) {
        //uncomment below and update the code to test getAllRequests2
        //instance.getAllRequests2(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
