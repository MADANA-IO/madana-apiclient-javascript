...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.XmlNs0NodeInfo();
  });
  ...
  describe('XmlNs0NodeInfo', function() {
    it('should create an instance of XmlNs0NodeInfo', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.XmlNs0NodeInfo();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.XmlNs0NodeInfo);
    });
