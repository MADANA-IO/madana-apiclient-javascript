...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MadanaSampleclientJavascript.XmlNs0IPFSSystemInfo();
  });
  ...
  describe('XmlNs0IPFSSystemInfo', function() {
    it('should create an instance of XmlNs0IPFSSystemInfo', function() {
      ...
      //var instane = new MadanaSampleclientJavascript.XmlNs0IPFSSystemInfo();
      //expect(instance).to.be.a(MadanaSampleclientJavascript.XmlNs0IPFSSystemInfo);
    });
